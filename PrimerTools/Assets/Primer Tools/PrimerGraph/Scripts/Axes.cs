...
public class Axes : PrimerObject
{
    ...
    private List<Transform> xArrows = new List<Transform>();
    ...
    public void ShowAxisX()
    {
        xAxisMasterContainer.ScaleUpFromZero();
        graph.xHidden = false;
    }
    public void HideAxisX()
    {
        xAxisMasterContainer.ScaleDownToZero();
        graph.xHidden = true;
    }
    
    public void ShowAxisY()
    {
        yAxisMasterContainer.ScaleUpFromZero();
        graph.yHidden = false;
    }
    public void HideAxisY()
    {
        yAxisMasterContainer.ScaleDownToZero();
        graph.yHidden = true;
    }

    public void ShowAxisZ()
    {
        zAxisMasterContainer.ScaleUpFromZero();
        graph.zHidden = false;
    }
    public void HideAxisZ()
    {
        zAxisMasterContainer.ScaleDownToZero();
        graph.zHidden = true;
    }
